...
<!-- Mirrored from html.xpeedstudio.com/medizco/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 08:40:00 GMT -->
...
<head>
    ...
    <link href="{{ asset('fe/fonts.googleapis.com/cssa25e.css?family=Exo:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i') }}" rel="stylesheet">
    <link href="{{ asset('fe/fonts.googleapis.com/cssa8c7.css?family=Lato:300,300i,400,400i,700,700i,900,900i') }}" rel="stylesheet">
    <link href="{{ asset('fe/fonts.googleapis.com/css4861.css?family=Playfair+Display:400,400i,700,700i,900,900i') }}" rel="stylesheet">
    <link href="{{ asset('fe/fonts.googleapis.com/cssa3eb.css?family=Poppins:200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i') }}" rel="stylesheet">
    <link href="{{ asset('fe/fonts.googleapis.com/css1139.css?family=Roboto:300,300i,400,400i,500,500i,700,700i,900,900i') }}" rel="stylesheet">
    ...
    <link href="{{ asset('fe/css/icomoon-icons.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('fe/css/animation.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('fe/css/magnific-popup.css') }}">
    <link href="{{ asset('fe/css/jquery.fancybox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/jquery.mCustomScrollbar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/menu.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="page-wrapper">
                ...
                <div class="container">
                    <div class="xs-navbar clearfix">
                        ...
                        <div class="logo-outer">
                            <div class="logo"><a href="index-2.html"><img src="{{ asset('be/gambar-logo.jpeg') }}" alt="" title="" style="width: 100px; border-radius: 10px;"></a></div>
                        </div>
        ...
        <section class="banner-section">
            <div class="banner-carousel owl-carousel owl-theme">
                ...
                <!-- Slide Item -->
                <div class="slide-item" style="background-image: url({{ asset('fe/images/main-slider/1.jpg') }});">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="banner-column col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div class="link-box wow fadeInUp" data-wow-delay="1000ms">
                                    <a href="department.html" class="theme-btn btn-style-two"><i>Book Now</i> <span class="arrow icon icon-arrow_right"></span></a>
                                </div>
                            </div>
                            ...
                            <div class="image">
                                <img src="{{ asset('fe/images/main-slider/content-image.png') }}" alt="" />
                            </div>
                ...
                <div class="slide-item" style="background-image: url({{ asset('fe/images/main-slider/1.jpg') }});">
                    <div class="container xs-banner-container-parent">
                        <div class="clearfix">
                            ...
                            <div class="image">
                                <img src="{{ asset('fe/images/main-slider/content-image-2.png') }}" alt="" />
                            </div>
                ...
                <div class="slide-item" style="background-image: url({{ asset('fe/images/main-slider/1.jpg') }});">
                    <div class="container xs-banner-container-parent">
                        <div class="clearfix">
                            ...
                            <div class="image">
                                <img src="{{ asset('fe/images/main-slider/content-image-3.png') }}" alt="" />
                            </div>
        ...
        <section class="featured-section">
            <div class="pattern-layer" style="background-image:url({{ asset('fe/images/background/pattern-1.png')  }})"></div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="featured-block col-lg-4 col-md-6 col-sm-12">
                        <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image-layer" style="background-image:url({{ asset('fe/images/resource/feature-1.jpg') }})"></div>
                            <div class="icon-box">
        ...
        <section class="container-fluid">
            <div class="pattern-layer" style="background-image:url({{ asset('fe/images/background/pattern-2.png') }})"></div>
                ...
                <div class="clearfix">
                    ...
                    <div class="left-column">
                        <div class="inner-column">
                            <div class="shadow-one paroller" style="background-image:url({{ asset('fe/images/icons/shadow-1.png') }})" data-paroller-factor="0.15" data-paroller-factor-lg="0.15" data-paroller-factor-md="0.15" data-paroller-factor-sm="0.15" data-paroller-type="foreground" data-paroller-direction="horizontal"></div>
                            <div class="shadow-two paroller" style="background-image:url({{ asset('fe/images/icons/shadow-2.png') }})" data-paroller-factor="-0.15" data-paroller-factor-lg="-0.15" data-paroller-factor-md="-0.15" data-paroller-factor-sm="-0.15" data-paroller-type="foreground" data-paroller-direction="vertical"></div>
                            <div class="shadow-three paroller" style="background-image:url({{ asset('fe/images/icons/shadow-3.png') }})" data-paroller-factor="0.15" data-paroller-factor-lg="0.15" data-paroller-factor-md="0.15" data-paroller-factor-sm="0.15" data-paroller-type="foreground" data-paroller-direction="horizontal"></div>
                            <div class="image">
        ...
        <section class="team-section">
            <div class="team-pattern-layer" style="background-image:url({{ asset('fe/images/background/pattern-1.png') }})"></div>
            <div class="team-pattern-layer-two" style="background-image:url({{ asset('fe/images/background/pattern-5.png') }})"></div>
            <div class="container">
                ...
                <div class="team-carousel owl-carousel owl-theme">
                    ...
                    <div class="team-block">
                        <div class="inner-box">
                            <div class="image">
                                <img src="{{ asset('fe/images/resource/team-1.jpg') }}" alt="" />
                    ...
                    <div class="team-block">
                        <div class="inner-box">
                            <div class="image">
                                <img src="{{ asset('fe/images/resource/team-2.jpg')}}" alt="" />
                    ...
                    <div class="team-block">
                        <div class="inner-box">
                            <div class="image">
                                <img src="{{ asset('fe/images/resource/team-3.jpg') }}" alt="" />
                    ...
                    <div class="team-block">
                        <div class="inner-box">
                            <div class="image">
                                <img src="{{ asset('fe/images/resource/team-4.jpg') }}" alt="" />
        ...
        <section class="events-section">
            <div class="pattern-layer-two" style="background-image:url({{ asset('fe/images/background/pattern-5.png') }})"></div>
            <div class="container">
                <!-- Title Box -->
                <div class="title-box">
                    <div class="clearfix">
                            ...
                            <div class="event-block">
                                <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                    <div class="upper-box clearfix">
                                        ...
                                        <div class="image">
                                            <img src="{{ asset('fe/images/resource/author-1.jpg') }}" alt="" />
                                        </div>
                                        <ul class="event-list">
        ...
        <section class="news-section">
            <div class="pattern-layer-one" style="background-image:url({{ asset('fe/images/background/pattern-6.png') }})"></div>
            <div class="pattern-layer-two" style="background-image:url({{ asset('fe/images/background/pattern-7.png') }})"></div>
            <div class="container">
                <!-- Sec Title -->
                <div class="section-title text-center">
                    <h2>News & Blog</h2>
                ...
                <div class="news-carousel owl-carousel owl-theme">
                    ...
                    <div class="news-block">
                        <div class="inner-box">
                            <div class="image">
                                <a href="blog-detail.html"><img src="{{ asset('fe/images/resource/news-1.jpg') }}" alt="" /></a>
                    ...
                    <div class="news-block">
                        <div class="inner-box">
                            <div class="image">
                                <a href="blog-detail.html"><img src="{{ asset('fe/images/resource/news-2.jpg') }}" alt="" /></a>
                    ...
                    <div class="news-block">
                        <div class="inner-box">
                            <div class="image">
                                <a href="blog-detail.html"><img src="{{ asset('fe/images/resource/news-3.jpg') }}" alt="" /></a>
            ...
            <div class="container">
                ...
                <div class="sponsors-outer">
                    ...
                    <ul class="sponsors-carousel owl-carousel owl-theme">
                        <li class="slide-item">
                            <figure class="image-box"><a href="#"><img src="{{ asset('fe/images/clients/1.png') }}" alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="image-box"><a href="#"><img src="{{ asset('fe/images/clients/2.png') }}" alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="image-box"><a href="#"><img src="{{ asset('fe/images/clients/3.png') }}" alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="image-box"><a href="#"><img src="{{ asset('fe/images/clients/4.png') }}" alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="image-box"><a href="#"><img src="{{ asset('fe/images/clients/5.png') }}" alt=""></a></figure>
                        </li>
                        <li class="slide-item">
                            <figure class="image-box"><a href="#"><img src="{{ asset('fe/images/clients/1.png') }}" alt=""></a></figure>
                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="footer-column col-lg-6 col-md-6">
                            <div class="footer-widget logo-widget">
                                <div class="logo">
                                    <a href="index-2.html"><img src="{{ asset('fe/images/footer-logo.png') }}" alt="" /></a>
                                </div>
                                ...
                                <ul class="list-style-two">
                                    ...
                                    <li><a href="https://html.xpeedstudio.com/cdn-cgi/l/email-protection#fb92959d94bb9e839a968b979ed5989496"><span class="icon flaticon-mail"></span><span class="__cf_email__" data-cfemail="01686f676e416479606c716d642f626e6c">[email&#160;protected]</span></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="contact-info">
                                ...
                                <ul class="list-style-one">
                                    ...
                                    <li><span class="icon flaticon-letter"></span><a href="https://html.xpeedstudio.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="337e56575a49505c73545e525a5f1d505c5e">[email&#160;protected]</a></li>
    ...
    <script src="{{ asset('fe/js/js/jquery-ui.js') }}"></script>
    ...
    <script src="{{ asset('fe/js/paroller.js') }}"></script>
    <script src="{{ asset('fe/js/wow.js') }}"></script>
    <script src="{{ asset('fe/js/main.js') }}"></script>
    <script src="{{ asset('fe/js/nav-tool.js') }}"></script>
