...
<!-- JS Libraies -->
<script src="{{ asset('be/dist/assets/modules/jquery.sparkline.min.js') }}"></script>
<script src="{{ asset('be/dist/assets/modules/chart.min.js') }}"></script>
<script src="{{ asset('be/dist/assets/modules/owlcarousel2/dist/owl.carousel.min.js') }}"></script>
